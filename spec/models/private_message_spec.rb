...
describe PrivateMessage do
  ...
  it "should place a new private message in outbox of sender and inbox of receiver" do
    @msg.should have(:no).errors_on(:attribute)
    @msg.save!
    @author.outbox.private_messages.count.should be(1)
    @recipient_1.inbox.private_messages.count.should be(1)
    @recipient_2.inbox.private_messages.count.should be(1)
  end
  
  it "should return the list of recipients for a private message" do
    @msg.valid?.should be_true
    @msg.save!
    @msg.recipients.length.should be(2)
  end

  it "should store private message thread" do
    @msg.save!
    
    msg2 = PrivateMessage.new(
      :subject => "first msg",
    ...
    msg4.root.class.should be(PrivateMessage)
  end
end
